...
public class CreateNewPreferenceITest {
    ...
    @Test
    void createNewNotificationPreference_happyPath() throws Exception {
        ...
        UpsertNotificationPreference notificationPreference = UpsertNotificationPreference.builder ()
                ...
                .contactInfo ("test@wp.pl")
                .build ();


        // When
        NotificationPreference preferences = notificationService.upsertPreference (notificationPreference);
