...
public class SubscribeITest {
    ...
    @Test
     void subscribeToPlan_happyPath() {
        ...
        assertEquals (SubscriptionPeriod.MONTHLY, premiumSubscription.get ().getPeriod ());
        ...
        Wallet walletUser = userWallet.get ();
        // 20.00 EUR - 19.99 EUR = 0.01 EUR
        assertThat (walletUser.getBalance (), comparesEqualTo (new BigDecimal ("0.01")));
    }
}
